...
router.get('/add_book',auth.userAuth,(req,res)=>{
    ...
    try {
        ...
        Category.find((err,data)=>{
            if(err)
                ...
                res.render('User/pages/add_book',{data:data});
        });
    } catch (error) {
...
router.post('/add_book',bookUpload.single('book_image'),auth.userAuth,async (req,res)=>{
